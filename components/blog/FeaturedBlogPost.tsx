  ...
  return (
    <div className=" py-24 sm:py-32">
      <article className="flex flex-col items-center xsm:flex-row py-5">
        <h2 className="text-red-500 text-center mb-[100px] font-bold text-3xl md:text-4xl lg:text-5xl">
          Recent Blog Posts
        </h2>
      </article>
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-12 px-6 sm:gap-y-16 lg:grid-cols-2 lg:px-8">
        <article className="mx-auto w-full max-w-2xl lg:mx-0 lg:max-w-lg">
          <time dateTime={featuredPost.datetime} className="block text-sm leading-6 text-gray-400">
            {featuredPost.date}
          </time>
          <h2 id="featured-post" className="mt-4 text-3xl font-bold tracking-tight text-red-500 sm:text-4xl">
            {featuredPost.title}
          </h2>
          ...
          <div className="mt-4 flex flex-col justify-between gap-6 sm:mt-8 sm:flex-row-reverse sm:gap-8 lg:mt-4 lg:flex-col">
            ...
            <div className="flex lg:border-t lg:border-gray-900/10 lg:pt-8">
              ...
              >
                <Image src={featuredPost.author.imageUrl} width={100} height={100} alt="" className="h-6 w-6 flex-none rounded-full text-white bg-gray-50" />
            ...
            {posts.map((post: BlogArticle) => (
              <article key={post.id} className="py-12">
                ...
                <div className="mt-4 flex">
                  ...
                  >
                    <Image src={post.authorImageUrl} width={100} height={100} alt="" className="h-6 w-6 flex-none rounded-full bg-gray-50" />
                    {post.authorName}
                  </a>
                </div>
              </article>
